...
public class afterAssigningPercentageRAReport extends TestBase {
...
//****************************	// 2.Initializing the Page Objects:*********************************************************
	...
	public afterAssigningPercentageRAReport() {
								...
								for (int j = 0; j < listOfEmpnamePercentageMonth.size(); j++) 
								{
									...
									if (textPercentage.equals(" " + monthSel + " ") || textPercentage == " " + monthSel + " "|| textPercentage.equalsIgnoreCase("" + monthSel + "")) 
									{
										...
										for (int k = 0; k < listOfEmpnamePercentageMonthA.size(); k++) {
											...
											Reporter.log("PASS -AFTER assigning percentage For Employee name '" + Ename_Spe + " 'his availaibity percentage is ' "+ textPercentageA + " 'of the month '" + monthSel, true);
											softAssertion.assertAll();
...
//												String textOverlay = onOverlayElement.getText();
												...
												Reporter.log("\n PASS - AFTER assigning percentage for Resource availability Percentage of particular selected Month value on overlay under project detail is: "	+ textOverlay,true);
												...
												if (covert >= 0 && covert <= 99) 
												{
													...
													for (int l = 0; l < projectDetialsLists.size(); l++) 
													{
														...
														Reporter.log(" \n PASS -AFTER assigning percentage of Project Details on the overlay is showing as  : "+ projectDetialsListsTexts, true);
														softAssertion.assertAll();
														// continue;
													}
												} 
												...
												{
													Reporter.log("PASS - AFTER assigning percentage of Project detials list is showing as blank because of resource is completely available : "+ Ename_Spe);
												}
												// To close overlay
